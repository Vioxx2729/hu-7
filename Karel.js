...
class Karel {
    ...
    move() {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { position: nextPosition });
        Karel.render(this.state);
    }
    turnLeft() {
        this.detectInfiniteLoop();
        ...
        this.state = Object.assign(Object.assign({}, this.state), { direction: newDirection });
        Karel.render(this.state);
    }
    pickBeeper() {
        this.detectInfiniteLoop();
        ...
        this.state = Object.assign(Object.assign({}, this.state), { beeperCount: this.state.beeperCount + 1, world: Karel.bySettingWorldElementAt(this.state.world, this.state.position, "none") });
        Karel.render(this.state);
    }
    putBeeper() {
        this.detectInfiniteLoop();
        ...
        this.state = Object.assign(Object.assign({}, this.state), { beeperCount: this.state.beeperCount - 1, world: Karel.bySettingWorldElementAt(this.state.world, this.state.position, "beeper") });
        Karel.render(this.state);
    }
    isWallInfront() {
        this.detectInfiniteLoop();
    ...
    detectInfiniteLoop() {
        this.callCount += 1;
        if (this.callCount > 10000000) {
            throw new Error("Infinite loop detected.");
        }
    }
    static getWorldElementAt(world, position) {
        var _a, _b;
        return (_b = ((_a = world[position[0]]) !== null && _a !== void 0 ? _a : {})[position[1]]) !== null && _b !== void 0 ? _b : "none";
    }
    static bySettingWorldElementAt(world, position, element) {
        return Object.assign(Object.assign({}, world), { [position[0]]: Object.assign(Object.assign({}, world[position[0]]), { [position[1]]: element }) });
    }
    static render(state) {
        const tileSize = 70;
        ...
        const yLetter = document.createElement("div");
        ...
        for (let y = 0; y < state.worldSize[1]; y += 1) {
            ...
            for (let x = 0; x < state.worldSize[0]; x += 1) {
                const tile = Karel.getWorldElementAt(state.world, [x, y]);
                if (y == 0) {
        ...
        const karel = document.createElement("div");
        karel.innerHTML = "🤖<br>";
        ...
        const beeperCounter = document.createElement("div");
